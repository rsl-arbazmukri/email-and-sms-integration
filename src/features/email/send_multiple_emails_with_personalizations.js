...
// Personalizations are an array of objects, each representing a separate email,
// that allow you to customize the metadata of each email sent within a request.
// The below example shows how multiple emails, each with varying metadata, are sent with personalizations.
const sendPersonalizedEmail = () => {
    const msg = {
